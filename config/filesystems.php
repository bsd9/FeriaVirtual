    ...
    */
    ...
    'disks' => [
        ...
        'configurations' => [
            ...
            'url' => env('APP_URL').'/storage/config',
            'visibility' => 'public',
        ],
        'companies' => [
            'driver' => 'local',
        ...
        'feriaImages' => [
            'driver' => 'local',
            'root' => storage_path('app/public/feria'),
            'url' => env('APP_URL').'/storage/feria',
            'visibility' => 'public',
        ],
        'blogs' => [
            'driver' => 'local',
        ...
        'audience' => [
            'driver' => 'local',
            'root' => storage_path('app/public/audience'),
            'url' => env('APP_URL').'/storage/audience',
            'visibility' => 'public',
        ],
