...
use App\Orchid\Screens\PavilionsListScreen;

use App\Orchid\Screens\PavilionsEditScreen;
...
Route::get('/api/pavilion/{pavilionId}/types', [PavilionController::class, 'getTypes']);

Route::screen('pavilions', PavilionsListScreen::class)->name('platform.pavilions');
Route::screen('pavilions/create', PavilionsEditScreen::class)->name('platform.pavilions.create');
Route::screen('pavilions/{pavilion}', PavilionsEditScreen::class)
    ->name('platform.pavilions.edit')
    ->whereNumber('pavilion');
