                ...
                <div class="card mt-3">
                    <div class="card-body">
                        <form method="post" action="{{ route('uploadImage.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="name" class="form-label">Nombre del stand <span
                            ...
                            <div class="mb-3">
                                ...
                                <select name="feria_id" id="feria_id" class="form-control @error('feria_id') is-invalid @enderror" required>
                                    ...
                                    @foreach ($ferias as $feria)
                                        <option value="{{ $feria->id }}" {{ $feria->feria_id == $feria->name ? 'selected' : '' }}>
                                            {{ $feria->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input name="descriptions" type="text"
                                       ...
                                       id="descriptions" value="{{ old('descriptions') }}" required/>
                                @error('descriptions')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
